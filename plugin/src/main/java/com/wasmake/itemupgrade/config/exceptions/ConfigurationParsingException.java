package com.wasmake.itemupgrade.config.exceptions;
...
public class ConfigurationParsingException extends ConfigurationException {
    ...
    public ConfigurationParsingException(String brief) {
        super();
        this.summary = brief;
    }
    ...
    public ConfigurationParsingException setCause(Exception cause) {
        this.cause = cause;
        return this;
    }

    public ConfigurationParsingException setDetail(String detail) {
        this.detail = detail;
        return this;
    }

    public ConfigurationParsingException setFieldPath(List<JsonMappingException.Reference> fieldPath) {
        this.fieldPath = fieldPath;
        return this;
    }

    public ConfigurationParsingException setLocation(JsonLocation location) {
        return location == null
                ? this
                : setLocation(location.getLineNr(), location.getColumnNr());
    }

    public ConfigurationParsingException setLocation(Mark mark) {
        return mark == null
                ? this
                : setLocation(mark.getLine(), mark.getColumn());
    }

    public ConfigurationParsingException setLocation(int line, int column) {
        this.line = line;
        this.column = column;
        return this;
    }

    public ConfigurationParsingException addSuggestion(String suggestion) {
        this.suggestionsSorted = false;
        this.suggestions.add(suggestion);
        return this;
    }

    public ConfigurationParsingException addSuggestions(Collection<String> suggestions) {
        this.suggestionsSorted = false;
        this.suggestions.addAll(suggestions);
        return this;
    }

    public ConfigurationParsingException setSuggestionBase(String base) {
    ...
    public static ConfigurationParsingException builder(String brief){
        return new ConfigurationParsingException(brief);
    }
